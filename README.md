...
Names: Mario Tinoco, Ben Gonzalez, Rafael Maatouk
FE's
Players:
...
Conflict:
The puzzles inside the maze are obstacles that the players have to face together
Boundaries:
Players being in different rooms creates a dynamic where one player will guide the other through puzzles
Outcome:
